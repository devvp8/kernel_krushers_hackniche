      ...
      <main className="main-content">
        ...
        <div className="card-container">
          ...
          <div className="card more-options">
            <h3>More options</h3>
            <p>
              Explore ChatGPT's other capabilities, including writing different kinds of creative content, translating languages, and answering your questions in an informative way.
            </p>
          </div>
        </div>
        <div className="chat-container">
          <h2>Message ChatGPT</h2>
